...
"")
        ...
        self.gridLayout_4 = QGridLayout(self.frame_content)
        ...
        self.label_Lecturadecodigodebarras = QLabel(self.page_home)
        self.label_Lecturadecodigodebarras.setObjectName(u"label_Lecturadecodigodebarras")
        font2 = QFont()
        font2.setFamily(u"Segoe UI")
        font2.setPointSize(40)
        self.label_Lecturadecodigodebarras.setFont(font2)
        self.label_Lecturadecodigodebarras.setStyleSheet(u"")
        self.label_Lecturadecodigodebarras.setAlignment(Qt.AlignCenter)

        self.gridLayout_2.addWidget(self.label_Lecturadecodigodebarras, 0, 0, 1, 2)
        ...
        self.btnRegisterVale.setFont(font3)
...
"}")
        ...
        self.btnActualizarDB.setFont(font3)
...
"}")
        ...
        self.EliminarTODO.setFont(font3)
...
"}")
        ...
        self.page_consolidado = QWidget()
        self.page_consolidado.setObjectName(u"page_consolidado")
        self.page_consolidado.setEnabled(True)
        self.horizontalLayout_12 = QHBoxLayout(self.page_consolidado)
        self.horizontalLayout_12.setObjectName(u"horizontalLayout_12")
        self.widget = QWidget(self.page_consolidado)
        self.widget.setObjectName(u"widget")
        self.widget.setMaximumSize(QSize(931, 671))
        self.gridLayout_3 = QGridLayout(self.widget)
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.Widget_Pagos_empleados = QWidget(self.widget)
        self.Widget_Pagos_empleados.setObjectName(u"Widget_Pagos_empleados")
        self.horizontalLayout_11 = QHBoxLayout(self.Widget_Pagos_empleados)
        self.horizontalLayout_11.setObjectName(u"horizontalLayout_11")
        self.Widget_Pagos_Satelites = QWidget(self.Widget_Pagos_empleados)
        self.Widget_Pagos_Satelites.setObjectName(u"Widget_Pagos_Satelites")
        self.Widget_Pagos_Satelites.setMaximumSize(QSize(911, 18))
        self.verticalLayout_12 = QVBoxLayout(self.Widget_Pagos_Satelites)
        self.verticalLayout_12.setObjectName(u"verticalLayout_12")

        self.horizontalLayout_11.addWidget(self.Widget_Pagos_Satelites)


        self.gridLayout_3.addWidget(self.Widget_Pagos_empleados, 1, 0, 1, 1)

        self.label_Consolidado_Pagos = QLabel(self.widget)
        self.label_Consolidado_Pagos.setObjectName(u"label_Consolidado_Pagos")

        self.gridLayout_3.addWidget(self.label_Consolidado_Pagos, 0, 0, 1, 1)

        self.horizontalLayout = QHBoxLayout()
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.scrollAreaWidget_Pagos_Satelites = QScrollArea(self.widget)
        self.scrollAreaWidget_Pagos_Satelites.setObjectName(u"scrollAreaWidget_Pagos_Satelites")
        ...
        self.scrollAreaWidget_Pagos_empleados = QScrollArea(self.widget)
        self.scrollAreaWidget_Pagos_empleados.setObjectName(u"scrollAreaWidget_Pagos_empleados")
        ...
        self.stackedWidget.addWidget(self.page_consolidado)
        ...
        sizePolicy4.setHeightForWidth(self.label_Lecturadecodigodebarras_2.sizePolicy().hasHeightForWidth())
        self.label_Lecturadecodigodebarras_2.setSizePolicy(sizePolicy4)
        self.label_Lecturadecodigodebarras_2.setMinimumSize(QSize(0, 71))
        self.label_Lecturadecodigodebarras_2.setFont(font2)
        self.label_Lecturadecodigodebarras_2.setAutoFillBackground(False)
        self.label_Lecturadecodigodebarras_2.setStyleSheet(u"")
        self.label_Lecturadecodigodebarras_2.setAlignment(Qt.AlignCenter)
...
"}")
        ...
        self.btnAgregarEmpleado.setFont(font3)
...
"}")
        ...
        self.frame_inferior = QFrame(self.page_widgets)
        self.frame_inferior.setObjectName(u"frame_inferior")
        self.frame_inferior.setMinimumSize(QSize(0, 150))
        self.frame_inferior.setFrameShape(QFrame.StyledPanel)
        self.frame_inferior.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_9 = QHBoxLayout(self.frame_inferior)
        self.horizontalLayout_9.setObjectName(u"horizontalLayout_9")
        self.CuadroCamposTicketColorNombreop = QFrame(self.frame_inferior)
        self.CuadroCamposTicketColorNombreop.setObjectName(u"CuadroCamposTicketColorNombreop")
        self.CuadroCamposTicketColorNombreop.setStyleSheet(u"border-radius: 5px;")
        self.CuadroCamposTicketColorNombreop.setFrameShape(QFrame.StyledPanel)
        self.CuadroCamposTicketColorNombreop.setFrameShadow(QFrame.Raised)
        self.verticalLayout_7 = QVBoxLayout(self.CuadroCamposTicketColorNombreop)
        self.verticalLayout_7.setObjectName(u"verticalLayout_7")
        self.frame_div_content_9 = QFrame(self.CuadroCamposTicketColorNombreop)
        self.frame_div_content_9.setObjectName(u"frame_div_content_9")
        self.frame_div_content_9.setMinimumSize(QSize(0, 110))
        self.frame_div_content_9.setMaximumSize(QSize(441, 110))
...
"")
        ...
        self.verticalLayout_43 = QVBoxLayout(self.frame_div_content_9)
        ...
        self.verticalLayout_48 = QVBoxLayout(self.frame_title_wid_9)
        self.verticalLayout_48.setObjectName(u"verticalLayout_48")
        self.labelBoxBlenderInstalation_22 = QLabel(self.frame_title_wid_9)
        self.labelBoxBlenderInstalation_22.setObjectName(u"labelBoxBlenderInstalation_22")
        self.labelBoxBlenderInstalation_22.setFont(font1)
        self.labelBoxBlenderInstalation_22.setStyleSheet(u"")

        self.verticalLayout_48.addWidget(self.labelBoxBlenderInstalation_22)


        self.verticalLayout_43.addWidget(self.frame_title_wid_9)

        self.CampoColor = QLineEdit(self.frame_div_content_9)
...
"}")
        ...
        self.verticalLayout_43.addWidget(self.CampoColor)


        self.verticalLayout_7.addWidget(self.frame_div_content_9)

        self.frame_div_content_8 = QFrame(self.CuadroCamposTicketColorNombreop)
...
"}")
        ...
        self.frame_div_content_6 = QFrame(self.CuadroCamposTicketColorNombreop)
...
"")
        ...
        self.CampoNombreResponsable = QLineEdit(self.frame_div_content_6)
        self.CampoNombreResponsable.setObjectName(u"CampoNombreResponsable")
        self.CampoNombreResponsable.setMinimumSize(QSize(0, 30))
        self.CampoNombreResponsable.setStyleSheet(u"QLineEdit {\n"
"	background-color: rgb(27, 29, 35);\n"
"	border-radius: 5px;\n"
"	border: 2px solid rgb(27, 29, 35);\n"
"	padding-left: 10px;\n"
...
"}")
        ...
        self.verticalLayout_40.addWidget(self.CampoNombreResponsable)


        self.verticalLayout_7.addWidget(self.frame_div_content_6)


        self.horizontalLayout_9.addWidget(self.CuadroCamposTicketColorNombreop)

        self.scrollArea = QScrollArea(self.frame_inferior)
        self.scrollArea.setObjectName(u"scrollArea")
        self.scrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 340, 383))
...
"}")
        ...
        self.PreviwImage = QGraphicsView(self.frame_inferior)
        self.PreviwImage.setObjectName(u"PreviwImage")

        self.horizontalLayout_9.addWidget(self.PreviwImage)


        self.gridLayout_9.addWidget(self.frame_inferior, 1, 0, 1, 1)
        ...
        self.pushButtonGuardar.setFont(font3)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_title_bar_top.setText(QCoreApplication.translate("MainWindow", u"Gestor de Vales", None))
        self.label_Lecturadecodigodebarras.setText(QCoreApplication.translate("MainWindow", u"Lectura de Tickets", None))
        ...
        self.btnRegisterVale.setText(QCoreApplication.translate("MainWindow", u"Limpiar Vista", None))
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Creacion de Vales", None))
        ...
        self.CampoTalla_36.setPlaceholderText(QCoreApplication.translate("MainWindow", u"36", None))
        self.CampoTalla_34.setText("")
        self.CampoTalla_34.setPlaceholderText(QCoreApplication.translate("MainWindow", u"34", None))
        self.CampoTalla_37.setText("")
        self.CampoTalla_37.setPlaceholderText(QCoreApplication.translate("MainWindow", u"37", None))
        self.CampoTalla_38.setText("")
        self.CampoTalla_38.setPlaceholderText(QCoreApplication.translate("MainWindow", u"38", None))
        self.CampoTalla_40.setText("")
        self.CampoTalla_40.setPlaceholderText(QCoreApplication.translate("MainWindow", u"40", None))
        self.CampoTalla_39.setText("")
        self.CampoTalla_39.setPlaceholderText(QCoreApplication.translate("MainWindow", u"39", None))
        self.CampoTalla_42.setText("")
        self.CampoTalla_42.setPlaceholderText(QCoreApplication.translate("MainWindow", u"42", None))
        self.CampoTalla_48.setText("")
        self.CampoTalla_48.setPlaceholderText(QCoreApplication.translate("MainWindow", u"48", None))
        self.CampoTalla_47.setText("")
        self.CampoTalla_47.setPlaceholderText(QCoreApplication.translate("MainWindow", u"47", None))
        self.CampoTalla_44.setText("")
        self.CampoTalla_44.setPlaceholderText(QCoreApplication.translate("MainWindow", u"44", None))
        self.CampoTalla_41.setText("")
        self.CampoTalla_41.setPlaceholderText(QCoreApplication.translate("MainWindow", u"41", None))
        self.CampoTalla_45.setText("")
        self.CampoTalla_45.setPlaceholderText(QCoreApplication.translate("MainWindow", u"45", None))
        self.CampoTalla_46.setText("")
        self.CampoTalla_46.setPlaceholderText(QCoreApplication.translate("MainWindow", u"46", None))
        self.CampoTalla_43.setText("")
        self.CampoTalla_43.setPlaceholderText(QCoreApplication.translate("MainWindow", u"43", None))
        self.CampoTalla_33.setText("")
        self.CampoTalla_33.setPlaceholderText(QCoreApplication.translate("MainWindow", u"33", None))
        self.labelBoxBlenderInstalation_22.setText(QCoreApplication.translate("MainWindow", u"Color", None))
        ...
        self.labelBoxBlenderInstalation_21.setText(QCoreApplication.translate("MainWindow", u"Nombre Satelite o Empleado (Opcional)", None))
        self.CampoNombreResponsable.setText("")
        self.CampoNombreResponsable.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Color", None))
        ...
        self.pushButtonGuardar.setText(QCoreApplication.translate("MainWindow", u"Guardar Vale", None))
